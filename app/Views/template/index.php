...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo base_url(); ?>/assets/dist/img/8.png" alt="AdminLTELogo" height="90" width="200">
  </div>
...
<script src="<?php echo base_url(); ?>/assets/dist/https://cdn.datatables.net/1.13.5/js/jquery.dataTables.min.js"></script>
    <script>
