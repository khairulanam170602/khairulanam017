                ...
                <form action="<?php echo $action; ?>" method="post">
                  ...
                  ?>
                        ...
                        if(current_url(true)->getSegment(2) =='edit'){
                            ?>
                            <input type="hidden" name="param" id="param" value="<?php echo $edit_data['kd_semister'];?>">
                            <?php
                        }
                        ?>
                        <div class="form-group">
                            <label for="nama_prodi">Kode jurusan</label>
                            <input type="text" name="kd_semister" id="kd_semister" value="<?php echo empty (set_value('kd_semister')) ? (empty ($edit_data['kd_semister']) ?"":$edit_data['kd_semister']) : set_value('ka_prodi') ?>" class="form-control">
                        </div>
                        <div class="form-group">
